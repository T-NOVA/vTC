...
GIT info: stable:1eb827023788cc071a06b70beb7834aae3c8d555 (Thu Nov 12 21:27:20 2015 +0200)
...
\/bin/rm -fv /lib/modules/$kernel/weak-updates/%{module_name}* /lib/modules/$kernel/extra/%{module_name}*
exit 0
